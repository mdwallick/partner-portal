...
async function testAuth0Simple() {
  try {
    ...
    console.log('- AUTH0_DOMAIN:', process.env.AUTH0_DOMAIN ? `✅ Set (${process.env.AUTH0_DOMAIN})` : '❌ Not set');
    ...
    console.log('Available methods:', Object.keys(managementClient).filter(key => typeof managementClient[key] === 'object'));
