          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              <div className="flex-shrink-0 relative">
                ...
                <div
                  className={`h-20 w-20 bg-gradient-to-br from-orange-500 to-purple-600 rounded-lg flex items-center justify-center text-white text-3xl font-bold ${game.picture_url ? "hidden" : ""}`}
                >
              ...
              <div>
                ...
                {game.description && (
                  <p className="text-sm text-gray-400 mt-1 max-w-2xl">{game.description}</p>
                )}
              </div>
            </div>
