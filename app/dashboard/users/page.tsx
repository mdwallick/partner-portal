...
import { Plus, Search, Filter, MoreVertical, Edit, Trash2, Eye, Mail, Phone, Calendar, Shield, ArrowLeft } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-900 flex items-center justify-center">
      <div className="max-w-md mx-auto text-center">
        ...
        <p className="text-gray-400 mb-8">
          You don't have permission to access the global users management page. 
          User management is handled at the partner level.
        </p>
